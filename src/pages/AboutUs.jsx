            ...
            <div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-9">
                            ...
                            <div className="lg:pl-[100px] flex items-center">
                                <div className="data w-full">
                                    <h1
                                        className="font-DanaDemiBold font-bold text-4xl lg:text-5xl text-black mb-9 max-lg:text-center relative">
                                        درباره سین شین
                                    </h1>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
                            ...
                            <div className="lg:pr-24 flex items-center">
                                <div className="data w-full">
                                    <img src="https://pagedone.io/asset/uploads/1702034785.png" alt="About Us tailwind page"
                                        className="block lg:hidden mb-9 mx-auto object-cover"></img>
                                    <h2 className="font-DanaDemiBold font-bold text-4xl lg:text-5xl text-black mb-9 max-lg:text-center">
                                        کارمونو از سال 94 شروع کردیم..
                                    </h2>
                                    <p className="font-DanaRegular text-justify text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                            ...
                            <div className="img-box ">
                                <img src="https://images.squarespace-cdn.com/content/v1/5e1bf69d91ea300d7f58e035/7cb1c5d3-1dfb-4f75-a940-45e8840af5ec/dylan-gillis-KdeqA3aTnBY-unsplash.jpg?format=2500w" alt="About Us tailwind page"
                                    className="hidden lg:block rounded-xl object-cover"></img>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-20 bg-white">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <h2 className="font-DanaDemiBold text-4xl text-center text-gray-900 font-bold mb-14">
                            نتایجی که سین شین تا به امروز رقم زده
                        </h2>
                        <div className="flex flex-col gap-5 xl:gap-8 lg:flex-row lg:justify-between">
                            <div
                                className="w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 drop-shadow-sm bg-white p-6 rounded-2xl shadow-md shadow-gray-100">
                                <div className="flex gap-5">
                                    <div className="font-DanaDemiBold text-2xl font-bold text-pink-600">
                                        240%
                                    </div>
                                    <div className="flex-1">
                                        <h4 className="text-xl text-gray-900 font-semibold mb-2">میزان رشد</h4>
                            ...
                            <div
                                ...
                                <div className="flex gap-5">
                                    ...
                                    <div className="flex-1">
                                        <h4 className="text-xl text-gray-900 font-semibold mb-2">اشتغال زایی</h4>
                                        <p className="text-xs text-gray-500 leading-5">
                                    ...
                                    <div
                                        ...
                                        <div className=" w-full lg:w-48 h-64">
                                            <img src="https://pagedone.io/asset/uploads/1696238786.png" alt="image"
                                                className="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full"></img>
                                        </div>
                                        <div className="text-center lg:text-left lg:max-w-xs flex-1">
                                            <div className="mb-5 pb-5 border-b border-solid border-gray-300">
                                                ...
                                                <span className="text-sm text-gray-500 group-hover:text-pink-500">Co-Founder &
                                                    CEO</span>
                                            </div>
                                            ...
                                            <div className="flex items-center gap-4 justify-center lg:justify-start">
                                                <p
                                                    className="cursor-pointer  text-gray-900 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-pink-500">
