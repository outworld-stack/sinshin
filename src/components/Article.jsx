  ...
  return (
    <div>
        <div className="flex gap-x-2.5 sm:block p-2.5 md:pb-2 bg-red-50/50 border border-gray-200 hover:shadow-sm shadow-gray-200  rounded-2xl">
            {/* <!-- عکس مقاله  --> */}
            <div className="relative w-[130px] h-[130px] sm:w-auto sm:h-auto shrink-0  sm:mb-4 rounded-2xl rounded-bl-3xl overflow-hidden">
            ...
            <div className="w-full flex flex-col sm:flex-row items-start justify-between font-VazirLight md:font-VazirMedium">
                ...
                <Link to={`/article/${props.id}`} className="font-DanaMedium text-sm/7 mt-2.5 ml-1.5 sm:ml-0 sm:mt-0 md:text-lg line-clamp-2 max-w-[193px] text-zinc-700 dark:text-white">
                    {props.title}
                </Link>
